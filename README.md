...
* **Arquitetura Modular (ES6):** O código foi desenvolvido e separado em módulos (`Core`, `Entities`, `Utils`) para garantir escalabilidade, facilidade de manutenção e *Separation of Concerns*.
